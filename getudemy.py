...
def register_udemycourse():
    ...
    startRect = locate_rectangle(['pics\\gotocoursegreenbg_cht.png', 'pics\\startlearnredbg_cht.png'])
    if startRect != None:
        pyautogui.PAUSE = 1
    ...
    freeRect = locate_rectangle(['pics\\free_cht.png', 'pics\\free_chs.png', 'pics\\free_small_cht.png'], 0.7)
    if freeRect == None:
    ...
    startRect = locate_rectangle(['pics\\startlearnredbg_cht.png'])
    if startRect == None:
